...
public class MagicTextView extends TextView {
    ...
    public void init(AttributeSet attrs){
        ...
        if(attrs != null){
            ...
            if(a.hasValue(R.styleable.MagicTextView_mystrokeColor)){
                float strokeWidth = a.getFloat(R.styleable.MagicTextView_mystrokeWidth, 1);
                int strokeColor = a.getColor(R.styleable.MagicTextView_mystrokeColor, 0xff000000);
                float strokeMiter = a.getFloat(R.styleable.MagicTextView_mystrokeMiter, 10);
                Join strokeJoin = null;
                switch(a.getInt(R.styleable.MagicTextView_mystrokeJoinStyle, 0)){
