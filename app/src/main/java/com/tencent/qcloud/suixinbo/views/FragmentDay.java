...
import com.tencent.qcloud.suixinbo.views.customviews.MonthDayDatePicker;
 ...
 * date:   On 2016/6/22
 */
public class FragmentDay extends BaseFragment implements View.OnClickListener {
    ...
    private TextView tv_months_week;
    private TextView tv_weeks_week;
    ...
    private void initId() {
        ...
        ll_time_day = (LinearLayout) view.findViewById(R.id.ll_time_day);
        ll_time_day.setOnClickListener(this);
        ll_time_day.setVisibility(View.VISIBLE);

        tv_months_week = (TextView) view.findViewById(R.id.tv_months_week); //月
        tv_weeks_week = (TextView) view.findViewById(R.id.tv_weeks_week); //日
...
//        calendar.setTime(DateUtil.strToDate("yyyy-MM", id_tv_time_year.getText().toString()));
        new MonthDayDatePicker(getActivity(), AlertDialog.THEME_HOLO_LIGHT, new DatePickerDialog.OnDateSetListener() {
            @Override
