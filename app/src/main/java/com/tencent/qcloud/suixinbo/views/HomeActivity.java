...
public class HomeActivity extends BaseFragmentActivity implements ProfileView {
    ...
    private final Class fragmentArray[] = {HomeFragment.class, FragmentPublish.class, PersionalFragment.class};
    private int mImageViewArray[] = {R.drawable.tab_live, R.mipmap.lu, R.drawable.tab_profile};
